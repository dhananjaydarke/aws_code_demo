...
docker tag students-backend:latest 437147519305.dkr.ecr.us-east-1.amazonaws.com/students-backend:latest
# 4. Push to ECR
docker push 437147519305.dkr.ecr.us-east-1.amazonaws.com/students-backend:latest
